...
$qry="Select * from stock, item where item.iid=stock.iid";


$result=$conn->query($qry);
$str="<table  class='table table-striped'><tr><th>Item Name</th><th>Reorder</th><th>Edit</th><th>Delete</th></tr>";
while($row=$result->fetch_assoc())
{
    ...
    $str.="<tr><td>$iname</td><td>$reorder</td><td>$edit</td><td>$delete</td></tr>";
}
