...
$qry="update product set pname='$pname',pprice='$pprce',pimage='$pimage',catid='$catid',pdesc='$pdesc' where pid='$pid'";
//echo $qry;
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" id="form-field-1" name="pdesc" value="<?php echo htmlspecialchars($pdesc); ?>" class="col-xs-12 col-sm-12">
</div>
