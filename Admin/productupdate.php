...
$qry="update product set (pname='$pname',pprice='$pprice',pimage='$pimage',catid='$catid',isdisplay='$isdisplay',pdesc='$pdesc') where pid='$pid'";
//echo $qry;
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" id="form-field-1" name="pprice" value="<?php echo htmlspecialchars($pprice); ?>" class="col-xs-5 col-sm-5">
</div>
<br>
<br>
<br>
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" id="form-field-1" name="pdesc" value="<?php echo htmlspecialchars($pdesc); ?>" class="col-xs-5 col-sm-5">
</div>
