...
:root{
  ...
  --accent:#A855F7;--accent2:#9333EA;--accent3:#C084FC;
  --accent-bg:rgba(168,85,247,0.08);--accent-bg2:rgba(168,85,247,0.15);
  ...
  --glow:0 0 24px rgba(168,85,247,0.25);--shadow-lg:0 12px 40px rgba(0,0,0,0.6);
}
...
.stat-icon{width:46px;height:46px;border-radius:11px;background:var(--accent-bg);border:1px solid rgba(168,85,247,0.2);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;}
...
.form-input:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(168,85,247,0.1);}
...
<aside class="sidebar">
  <div class="sidebar-logo">
    <div class="logo-mark"><div class="logo-icon">🛡️</div><div class="logo-text">Anand <span>Admin</span></div></div>
    <div class="logo-sub">Control Panel</div>
  </div>
  <div class="sidebar-user">
    <div class="user-avatar"><?php echo strtoupper(substr($_SESSION["name"]??"A",0,1)); ?></div>
    <div><div class="user-name"><?php echo htmlspecialchars($_SESSION["name"]??"Admin"); ?></div><div class="user-role">Administrator</div></div>
  </div>
  <nav class="nav-section">
    ...
    <a href="members.php" class="nav-item"><span class="nav-icon">👥</span> Members</a>
    <span class="nav-label">Branches</span>
    <a href="branchdisplay.php" class="nav-item"><span class="nav-icon">🏪</span> Branches</a>
    <a href="areadisplay.php" class="nav-item"><span class="nav-icon">📍</span> Areas</a>
    ...
    <a href="itemdisplay.php" class="nav-item"><span class="nav-icon">🥬</span> Items</a>
    <span class="nav-label">Stock</span>
    <a href="stockdisplay.php" class="nav-item"><span class="nav-icon">📦</span> Stock</a>
    <a href="sddisplay.php" class="nav-item"><span class="nav-icon">🚚</span> Deliveries</a>
    <a href="rolldisplay.php" class="nav-item"><span class="nav-icon">🛡️</span> Roles</a>
...
<div class="topbar">
  ...
  <div class="topbar-right">
    <span class="topbar-greeting">Welcome, <strong><?php echo htmlspecialchars($_SESSION["name"]??"Admin"); ?></strong></span>
  </div>
</div>
