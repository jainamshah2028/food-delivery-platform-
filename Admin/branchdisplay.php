...
$qry="Select bid,bad,contactno,bimage,areaname from branch,area where branch.areaid=area.areaid";


$result=$conn->query($qry);
$str="<table  class='table table-striped'><tr><th style='font-size:24px;'>Branch Address</th><th>Contact No</th><th>Area Name</th><th>Branch Image</th><th>Edit</th><th>Delete</th></tr>";
while($row=$result->fetch_assoc())
{
    ...
    $str.="<tr><td>$bad</td><td>$contactno</td><td>$areaid</td><td>$bimage</td><td>$edit</td><td>$delete</td></tr>";
}
