...
$qry="Select * from stock, item where stock.iid=item.iid";


$result=$conn->query($qry);
$str="<table  class='table table-striped'><tr><th>Branch ID</th><th>Item Name</th><th>Reorder</th><th>Edit</th><th>Delete</th></tr>";
while($row=$result->fetch_assoc())
{
    ...
    $str.="<tr><td>$bid</td><td>$iname</td><td>$reorder</td><td>$edit</td><td>$delete</td></tr>";
}
