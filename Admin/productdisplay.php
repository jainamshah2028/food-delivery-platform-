...
$str="<table  class='table table-striped'><tr><th style='font-size:24px;'>Product Name</th><th>Product Price</th><th>Product Image</th><th>Category ID</th><th>Product Description</th><th>Edit</th><th>Delete</th></tr>";
while($row=$result->fetch_assoc())
{
    ...
    $str.="<tr><td>$pname</td><td>$pprice</td><td>$pimage</td><td>$catid</td><td>$pdesc</td><td>$edit</td><td>$delete</td></tr>";
}
